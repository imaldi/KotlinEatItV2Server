...
import com.aim2u.kotlineatitv2server.eventbus.SelectAddonModel
import com.aim2u.kotlineatitv2server.eventbus.UpdateAddonModel
...
class MyAddonAdapter(var context: Context, var addonModelList: MutableList<AddonModel>) : RecyclerView.Adapter<MyAddonAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(LayoutInflater.from(context).inflate(R.layout.addon_size_layout_item,parent,false))
    }
